...
try {
    ...
    error_log("Viewer page DB error: " . $e->getMessage());
}
...
<head>
    ...
    <title>Empanelled Hospitals - Public View</title>
...
<div class="container-main">
    ...
    <form method="GET" action="viewer.php" class="row g-3 align-items-center my-2 p-2 bg-light border rounded animate__animated animate__fadeIn">
        <div class="col-md-3">
        ...
        <div class="col-md-2 d-flex gap-2">
            ...
            <a href="viewer.php" class="btn btn-outline-secondary w-100">Reset</a>
        </div>
    </form>
    ...
    <div class="table-responsive animate__animated animate__fadeInUp">
        <table class="table table-hover align-middle">
            <thead class="text-center">
                <tr>
                    <th>Name</th> <th>Address</th> <th>State</th>
            ...
            <?php if (empty($hospitals)): ?>
                <tr>
                    <td colspan="6" class="text-center">No hospitals found matching your criteria.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($hospitals as $row): $status = get_status($row['VALID_UPTO']); ?>
                    <tr>
                        <td>
